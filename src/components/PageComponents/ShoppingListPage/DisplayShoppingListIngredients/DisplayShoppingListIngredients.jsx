export default function DisplayShoppingListIngredients({
	foodCategories,
	combinedIngredients,
}) {
	return (
		<>
			{foodCategories.map((foodCategory) => {
				...
				const capitalizedFoodCategory =
					foodCategory.charAt(0).toUpperCase() +
					foodCategory.slice(1);
						...
						<div>
							...
							{combinedIngredients.map((ingredient) => {
								if (
									...
									const shoppingListQuantity =
										ingredient.shoppingListQuantity;
									return (
										<li
											key={
												ingredient.ingredientAndConversionCategory
											}
										>
											{
